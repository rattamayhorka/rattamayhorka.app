...
export default function Bullet({ refreshTrigger }) {
  ...
  return (
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-6rem)] w-full bg-theme-bg font-mono text-xs text-theme-text rounded-2xl border border-theme-border overflow-hidden shadow-xl">
      ...
      <div className="flex-1 overflow-y-auto bg-theme-bg scrollbar-none px-4 py-4 space-y-2">
        {cargando ? (
                    ...
                    <div className="opacity-0 group-hover:opacity-100 flex items-center gap-1.5 transition-all mr-1">
                      ...
                      {item.tipo === 'tarea' && (
                        <button 
                          ...
                          className="p-1 text-theme-text/50 hover:text-theme-accent hover:bg-theme-border/20 rounded cursor-pointer flex items-center gap-1"
                      ...
                      <button 
                        ...
                        className="p-1 text-theme-text/50 hover:text-theme-accent hover:bg-theme-border/20 rounded cursor-pointer"
                      ...
                      <button 
                        ...
                        className="p-1 text-theme-text/50 hover:text-theme-casa hover:bg-theme-border/20 rounded cursor-pointer"
